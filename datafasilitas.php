...
<?php
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "insert into datafasilitas value('$kodefasilitas', '$namafasilitas', 
            '$jumlahfasilitas', '$nama', '$statusfasilitas')");
  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="form-group row mb-2">
            <label for="search" class="col-sm-2">Nama Fasilitas</label>
            <div class="col-sm-6">
        ...
        <table class="table table-hover table-info table-bordered border-dark">
            ...
            {
                $search = $_POST['search'];
                $query = mysqli_query($connection, "select * from datafasilitas
                    where namafasilitas like '%".$search."%'");
            }else
                {
                    $query = mysqli_query($connection, "select * from datafasilitas");
                }
                ...
                { ?>
                    <tr style="text-align: center">
                        ...
                        <td><?php echo $row['statusfasilitas'];?></td>
