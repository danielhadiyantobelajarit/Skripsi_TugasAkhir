...
<?php
    ...
    if(isset($_POST['Simpan'])){
        ...
        $path = "files/kelas12/".$fileName;
        
        $query = "INSERT INTO filekelas12 VALUES ('$kodefile', '$fileName')";
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Daftar File Materi Pelajaran Kelas 12</h1>
                    <h5>File Materi Kelas 12 Download Di Sini</h5>
                </div>
            </div>
        <br>
        <table class="table table-hover table-success">
            ...
            <tbody>
                <?php 
                $query2 = "SELECT * FROM filekelas12";
